    ...
    <div className="card shadow-sm mb-4">
      <div className="card-header d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
        <div>
          ...
          <p className="mb-0 text-muted">Workouts data loaded from the REST API.</p>
        </div>
        <div className="d-flex gap-2">
          <button className="btn btn-primary" type="button" onClick={fetchWorkouts} disabled={loading}>
        ...
        <form className="row g-3 align-items-center mb-4">
          ...
          <div className="col-md-4 text-md-end">
            <p className="mb-0 text-muted">
              Showing {filteredItems.length} of {items.length} workouts
            </p>
          </div>
        </form>
